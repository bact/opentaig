...
def main() -> None:
    ...
    parser.add_argument(
        "--keyword", required=True, help="the search query actually typed"
    )
    parser.add_argument(
        "--hit-count",
        type=int,
    ...
    parser.add_argument(
        "--note",
        default="",
        help="free text: what was found, or why 0 leads is real negative evidence",
    )
    ...
    print(
        f"logged 1 web search to {args.log_path}: {args.keyword!r} "
